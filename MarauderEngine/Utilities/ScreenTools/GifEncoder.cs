...
namespace MarauderEngine.Utilities.ScreenTools
{
        ...
        public class GifEncoder : IDisposable
        {
            ...
            /// <param name="x">The positioning x Position this image should be displayed at.</param>
            /// <param name="y">The positioning y Position this image should be displayed at.</param>
