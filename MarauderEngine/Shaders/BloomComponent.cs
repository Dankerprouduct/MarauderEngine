...
namespace MarauderEngine.Shaders
{
    public class BloomComponent: DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            int width = GraphicsDevice.Viewport.Width; //pp.BackBufferWidth;
            int height = GraphicsDevice.Viewport.Height;//pp.BackBufferHeight;
            ...
            //sceneRenderTarget = new RenderTarget2D(GraphicsDevice.gra);
                                ...
                                Effect effect, IntermediateBuffer currentBuffer)
        {
            ...
            spriteBatch.Begin(0, BlendState.Additive, null, null, null, effect);
        ...
        void SetBlurEffectParameters(float dx, float dy)
        {
            ...
            for (int i = 0; i < sampleCount / 2; i++)
            {
                ...
                // than just one at a time. The 1.5 Position kicks things off by
