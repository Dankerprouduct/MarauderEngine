...
namespace MarauderEngine.Audio
{
    public class Synth
    {
        ...
        private readonly Dictionary<float, Voice> _keyRegistry;
        ...
        public Synth()
        {
            ...
            _keyRegistry = new Dictionary<float, Voice>();
        }
        ...
        public void NoteOn(float note)
        {
            ...
            freeVoice.Start(note);
            _activeVoices.Add(freeVoice);
        }
        public void NoteOff(float note)
        {
            Voice voice;
        ...
        public void SetAmplitude(int note, float amplitude)
        {
            if (_keyRegistry.ContainsKey(note))
            {
                _keyRegistry[note].Amplitude = amplitude;
            }
        }
